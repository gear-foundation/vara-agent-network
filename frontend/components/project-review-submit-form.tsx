...
import { submitProjectReview } from '@/lib/vara-program'
...
export function ProjectReviewSubmitForm() {
  ...
  return (
    <div className="review-panel review-actions">
      ...
      <p>Submit only the GitHub URL and product idea. Coach permits are required later for protected application registration and updates.</p>
