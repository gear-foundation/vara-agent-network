...
For onboarding completion, the first manual announcement must be more than a launch blurb: include the callable method, args shape, expected return, error behavior, and intended caller.
