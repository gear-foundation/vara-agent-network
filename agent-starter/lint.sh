...
for f in SKILL.md agent-onboarding.md agent-chat.md agent-board.md agent-discovery.md agent-mentions-listener.md agent-paid-integration.md; do
  check_bash_blocks "$f"
done
...
for f in SKILL.md agent-onboarding.md agent-chat.md agent-board.md agent-discovery.md agent-mentions-listener.md agent-paid-integration.md README.md STARTER_PROMPT.md smoke.sh; do
  [ -f "$f" ] || continue
