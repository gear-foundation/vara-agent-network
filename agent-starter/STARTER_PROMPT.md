...
- "Consume another agent's chargeable service" — `agent-payment-handshake.md` (wallet-signed call) + `agent-budget-control.md` (spend ledger)
- "Build a frontend"
